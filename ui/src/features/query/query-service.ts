...
async function validate(sql: string, options: ServiceRequestOptions = {}): Promise<QueryValidationResult> {
...
async function execute(sql: string, options: ServiceRequestOptions = {}): Promise<QueryExecutionResult> {
...
async function explain(sql: string, options: ServiceRequestOptions = {}): Promise<QueryExecutionResult> {
