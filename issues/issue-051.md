# Issue 051: Text Candidate Generation
...
`text candidate generation` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for text candidate generation within the V1 - Projection Query Engine scope.
