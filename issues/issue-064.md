...
`predicate pushdown` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for predicate pushdown within the V2 - Query Performance scope.
