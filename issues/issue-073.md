# Issue 073: Precomputed Scoring Metadata
...
`precomputed scoring metadata` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for precomputed scoring metadata within the V2 - Query Performance scope.
