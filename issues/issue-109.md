...
`EXPLAIN ANALYZE` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for EXPLAIN ANALYZE within the V3 - Advanced Query Features scope.
