# Issue 074: Top-K Search Execution
...
`top-k search execution` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for top-k search execution within the V2 - Query Performance scope.
