...
| Projection lifecycle | Experimental | Authoritative source query plus version/checkpoint state | Analytics projection, interruption, replay, comparison, repair, metrics, and bounded-resource suites | #28 owns lifecycle promotion and retained native-disk capacity evidence; stable CBM2 is not reopened by #11. |
