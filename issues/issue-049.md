# Issue 049: Embedding Validation
...
`embedding validation` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for embedding validation within the V1 - Projection Query Engine scope.
