...
| Transactions and savepoints | Implemented | Stable/Experimental with default/READ COMMITTED isolation, immediate single-collection staging, foreign-key action preflight, DDL/COPY restrictions, and irreversible COMMIT recovery with generation-bound maintenance debt |
