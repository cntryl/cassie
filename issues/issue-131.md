...
`full column-store tables` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for full column-store tables within the V5 - Verification & Advanced Execution scope.
