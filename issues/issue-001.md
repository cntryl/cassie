...
`row blob storage` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for row blob storage within the V1 - Projection Query Engine scope.
