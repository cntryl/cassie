...
`pgvector operators` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for pgvector operators within the V1 - Projection Query Engine scope.
