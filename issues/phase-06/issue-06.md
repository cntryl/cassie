# Phase 06 Issue 06: Access-Path Assertions And Diagnostics
...
- Depends on phase 06 issue 01 for the contract definitions.
- Consumes planner/executor behavior from phase 06 issues 02 through 05.
...
- Extend `PhysicalPlan` in `src/planner/physical.rs` with explicit read diagnostics after issue 01/02 settle the vocabulary:
  - `access_path`
  - `access_path_reason`
  - `fallback_reason`
  - `pagination_strategy`
