# Phase 07 Issue 06: Runtime Operator Switching
...
- Preserve phase 04 async/sync boundaries; switching must not spawn hidden blocking work from async transport tasks.
