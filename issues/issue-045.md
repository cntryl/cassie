...
`cosine distance` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for cosine distance within the V1 - Projection Query Engine scope.
