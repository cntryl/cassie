...
`top-k optimization` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for top-k optimization within the V2 - Query Performance scope.
