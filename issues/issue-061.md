...
`query statistics` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for query statistics within the V1 - Projection Query Engine scope.
