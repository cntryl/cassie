...
`batch execution` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for batch execution within the V1 - Projection Query Engine scope.
