...
`vector fields` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for vector fields within the V1 - Projection Query Engine scope.
