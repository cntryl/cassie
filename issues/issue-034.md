...
`primary key index` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for primary key index within the V1 - Projection Query Engine scope.
