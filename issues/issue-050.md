...
`hybrid_score()` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for hybrid_score() within the V1 - Projection Query Engine scope.
