...
`composite indexes` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for composite indexes within the V1 - Projection Query Engine scope.
