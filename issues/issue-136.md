...
`vectorized aggregation` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for vectorized aggregation within the V5 - Verification & Advanced Execution scope.
