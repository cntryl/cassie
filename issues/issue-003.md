# Issue 003: Field-Id Based Encoding
...
`field-id based encoding` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for field-id based encoding within the V1 - Projection Query Engine scope.
