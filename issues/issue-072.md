# Issue 072: Posting-List Optimizations
...
`posting-list optimizations` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for posting-list optimizations within the V2 - Query Performance scope.
