...
`PRIMARY KEY` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for PRIMARY KEY within the V1 - Projection Query Engine scope.
...
Treat constraints as projection validation and avoid partial row/index mutation on failure.
