...
`schema versioning` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for schema versioning within the V1 - Projection Query Engine scope.
