...
`runtime operator switching` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for runtime operator switching within the V5 - Verification & Advanced Execution scope.
