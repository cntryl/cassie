...
`projection integrity verification` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for projection integrity verification within the V5 - Verification & Advanced Execution scope.
