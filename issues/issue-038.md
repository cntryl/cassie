...
`inverted index` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for inverted index within the V1 - Projection Query Engine scope.
