...
`vector reranking` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for vector reranking within the V1 - Projection Query Engine scope.
