...
`scalar functions` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for scalar functions within the V1 - Projection Query Engine scope.
