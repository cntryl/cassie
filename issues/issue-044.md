...
`brute-force search` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for brute-force search within the V1 - Projection Query Engine scope.
