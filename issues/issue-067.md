# Issue 067: Index-Aware Planning
...
`index-aware planning` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for index-aware planning within the V2 - Query Performance scope.
