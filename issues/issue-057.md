...
`prepared statements` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for prepared statements within the V1 - Projection Query Engine scope.
