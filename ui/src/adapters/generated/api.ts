...
export function createAdapter(client: FetchClient): {
   ...
   * @returns Promise resolving to FetchResponse<ProjectionCheckReport>
   */
  createProjectionConsistencyReport: (
    body: ConsistencyCheckRequest,
    options?: { signal?: AbortSignal; timeout?: number; operationId?: string },
  ) => Promise<FetchResponse<ProjectionCheckReport>>;
  /**
   ...
   * @returns Promise resolving to FetchResponse<ProjectionManifest>
   */
  createProjectionVerificationManifest: (
    projection: string,
    body?: ExportManifestRequest,
    options?: { signal?: AbortSignal; timeout?: number; operationId?: string },
  ) => Promise<FetchResponse<ProjectionManifest>>;
   ...
   */
  createAdminQueryExplanation: (
    body: QueryExplainRequest,
    options?: { signal?: AbortSignal; timeout?: number; operationId?: string },
  ) => Promise<FetchResponse<QueryExplainResponse>>;
  /**
   ...
   */
  loginRestSession: (
    body: { database?: string; password: string; username: string },
    options?: { signal?: AbortSignal; timeout?: number; operationId?: string },
  ...
  return {
    ...
    createProjectionConsistencyReport: (
      ...
      const finalOptions = {
        ...options,
        operationId: options?.operationId ?? "createProjectionConsistencyReport",
      };
      return client.post(
        `/api/v1/admin/projection-consistency-reports`,
        body,
        undefined,
        finalOptions,
      );
    ...
    createProjectionVerificationManifest: (
      ...
      const finalOptions = {
        ...options,
        operationId: options?.operationId ?? "createProjectionVerificationManifest",
      };
      return client.post(
        `/api/v1/admin/projections/${encodeURIComponent(String(projection))}/verification-manifests`,
        body,
        undefined,
        finalOptions,
      );
    ...
    createAdminQueryExecution: (
      ...
      const finalOptions = {
        ...options,
        operationId: options?.operationId ?? "createAdminQueryExecution",
      };
    ...
    createAdminQueryExplanation: (
      ...
      const finalOptions = {
        ...options,
        operationId: options?.operationId ?? "createAdminQueryExplanation",
      };
    ...
    createAdminQueryValidation: (
      ...
      const finalOptions = {
        ...options,
        operationId: options?.operationId ?? "createAdminQueryValidation",
      };
