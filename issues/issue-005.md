...
`projection metadata` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for projection metadata within the V1 - Projection Query Engine scope.
