# Issue 075: SIMD Distance Calculations
...
`SIMD distance calculations` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for SIMD distance calculations within the V2 - Query Performance scope.
