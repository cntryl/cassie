...
`basic aggregates` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for basic aggregates within the V1 - Projection Query Engine scope.
