...
`physical plans` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for physical plans within the V1 - Projection Query Engine scope.
