...
`projection pruning` from `docs/milestones.md`.

## Goal

Deliver complete Cassie support for projection pruning within the V2 - Query Performance scope.
